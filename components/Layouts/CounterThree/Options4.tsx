...
import JustPlayScoreCard from "@/components/ScoreCards/JustPlayScoreCard";
...
const Options4: React.FC<OptionsProps> = ({ teeboxHoles, roundHoles, round, holeNumber }) => {
            ...
            switch (icon) {
                case 'score':
                    return (
                        ...
                        //     round={round}
                        // />
                        <JustPlayScoreCard round={round} setModalVisible={() => toggleModal(icon)} modalVisible={modalVisibility[icon]} />
                    );
                case 'bar':
          ...
          <Ionicons name="caret-down-circle-outline" color={'whitesmoke'} size={20} />
            ...
            <View style={[styles.animatedView]}>
                ...
                <View style={{ marginHorizontal: 10 }}>
                    {/* <View style={{ marginVertical: 10 }}>
                        {OptionBtn2('Hole History', 'dot')}
                    </View> */}
                    <View style={{ marginVertical: 20 }}>
                        {OptionBtn2('Round Stats', 'bar')}
                    </View>
