...
import { ProgressBar } from "@/components/RoundSummary/GIRFIR";
...
export const RoundView = ({ round }: { round: Round }) => {
    ...
    const firEligibleHoles = Object.values(round.holes)
  .filter((hole:HoleStats) => hole.hole.par > 3)
  .length;
    const data = [{ value: 0 }];
                ...
                <View style={{ flexDirection: 'row', marginVertical: 10 }}>
                    ...
                    <View style={styles.leftStatFull}>
                        ...
                        <View style={{ marginBottom: 10, justifyContent: 'center', alignItems: 'center' }}>
                            ...
                            <Text style={[styles.rightStatNum,{fontSize:50, color:'white'}]}>{round.toPar > 0 ? '+' : ''}{round.toPar}</Text>
                        </View>
                    ...
                    <View style={{flexDirection:'row',width:'60%', marginTop:20}}>
                        <ProgressBar data={holesPlayed ? round.totalGIR/holesPlayed*100 : 0} text='GIR' />
                        <ProgressBar data={round.totalFIR/firEligibleHoles*100} text='FIR' />
                    </View>
