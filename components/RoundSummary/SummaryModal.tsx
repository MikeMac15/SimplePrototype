...
const SummaryModal: React.FC<SummaryModalProps> = ({round,course,tee}) => {
...
// round.addRoundHole(hole6, 1, 1, 2, 1, false, 0, true);
...
// round.addRoundHole(hole16, 2, 1, 0, 2, false, 0, true);
    ...
    return (
            ...
            <Modal
              ...
              <View style={styles.centeredView}>
                  ...
                  <RoundSummary round={round} course={course} tee={tee} />
