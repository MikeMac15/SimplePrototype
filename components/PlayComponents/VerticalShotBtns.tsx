...
const VerticalBtns: React.FC<BtnsProps> = ({addShot, subtractShot, shotData}) => {
    return (
        ...
        <TouchableOpacity activeOpacity={0.5} style={styles.shotBtn2} onPressIn={() => Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light)}
          ...
          <View style={{ backgroundColor: '#555', borderRadius: 20, borderWidth: 3, borderColor: '#73c7eb' }}>
            <View style={styles.centeredRow}>
              ...
              <View style={[styles.BtnCountContainer2, styles.pureBackground]}>
                <Text style={styles.BtnCount} >{shotData.pure}</Text>
              </View>
  
              <Text style={[styles.BtnText2, styles.pureText, styles.textShadow]}>Great</Text>
